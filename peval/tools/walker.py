...
class _Walker:
    ...
    def _walk_list(self, state: typing.Optional[immutableadict], lst, ctx: typing.Optional[immutableadict], block_context: bool=False):
        """
    ...
    def _walk_field(self, state: typing.Optional[immutableadict], value, ctx: typing.Optional[immutableadict], block_context: bool=False):
        """
    ...
    def _transform_field(self, ctx: immutableadict, value, block_context: bool=False):
    ...
    def _walk_fields(self, state: typing.Optional[immutableadict], node, ctx: typing.Optional[immutableadict]):
        """
    ...
    def _handle_node(self, state: typing.Optional[immutableadict], node, ctx: typing.Optional[immutableadict], list_context: bool=False, visiting_after: bool=False):
    ...
    def _walk_node(self, state: typing.Optional[immutableadict], node, ctx: typing.Optional[immutableadict], list_context: bool=False):
        """
